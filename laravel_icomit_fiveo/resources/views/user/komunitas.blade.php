                               ...
                               <ul class="nav navbar-nav menu_nav ml-auto">
                                   ...
                                   <li class="nav-item submenu dropdown">
                                       <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button"
                                           aria-haspopup="true" aria-expanded="false">{{ $pengguna->coname }}</a>
               ...
               <div class="container">
                   <div class="row">
                       <div class="col-lg-12 course_details_left">
                           ...
                           <div class="col-lg-12">
                               <form enctype="multipart/form-data" class="row contact_form" action="{{ url('/user-kom') }}"
                                   method="GET">
                                   <div class="col-md-4">
                                       <div class="form-group">
                                           <input type="text" name="keyword1" class="form-control"
                                               value="{{ Request::get('keyword1') }}" placeholder="Provinsi"
                                               onfocus="this.placeholder = ''" onblur="this.placeholder = 'Provinsi'"
                                               required="" />
                                       </div>
                                   ...
                                   <div class="col-md-4">
                                       <div class="form-group">
                                           ...
                                           <input type="text" class="form-control" name="keyword2"
                                               value="{{ Request::get('keyword2') }}" placeholder="Kabupaten"
                                               onfocus="this.placeholder = ''" onblur="this.placeholder = 'Kabupaten'"
                                               required="" />
                                       </div>
                                   </div>
                           ...
                           <div class="content section_gap2">
                               <ul class="course_list">
                                   @foreach ($pengguna1 as $pengguna)
                                       <li class="justify-content-between d-flex">
                                           <p>{{ $pengguna->coname }}</p>
                                           <a class="primary-btn text-uppercase"
                                               href="{{ url('detailpengguna2/' . $pengguna->id . '/') }}" method="GET">View
                                               Details</a>
                                       </li>
                                   @endforeach
