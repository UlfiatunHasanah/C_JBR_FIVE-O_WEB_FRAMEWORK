        ...
        <div class="row justify-content-center d-flex align-items-center">
          <div class="col-lg-3 col-md-6 col-sm-12 single-trainer">
            ...
            <div class="thumb d-flex justify-content-sm-center">
              ...
              @if ($pengguna->logo == "" || $pengguna->logo == null)
                 <img class="img-fluid" src="{{url('logo/basic.jpg') }}" alt="" />
                 @endif
    ...
    <section class="chooseus spad set-bg  section_gap_top " >
                        <div class="container">
                            ...
                            <h2 >Informasi Komunitas</h2>
                                        ...
                                        <form  action="/editkom/{{$pengguna->id}}/update" enctype="multipart/form-data" class="form-horizontal form-bordered" method="POST">
                                                @csrf
                                            <div class="form-group">
                                                <label class="col-lg-12 col-md-12 control-label" > Nama Komunitas</label>
                                                <div class="col-lg-12 col-md-12">
                                                    <input type="text" class="form-control" id="coname" name="coname" value="{{$pengguna->coname}}" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-12 col-md-12">
                                                    <input type="text" class="form-control" id="prov" name="prov" value="{{$pengguna->prov}}" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-12 col-md-12">
                                                    <input type="text" class="form-control" id="kab" name="kab" value="{{$pengguna->kab}}">
                                                </div>
                                            </div>

                                            
                                            <div class="form-group">
                                                <label class="col-lg-12 col-md-12 control-label" > Deskripsi Komunitas</label>
                                                <div class="col-md-12">
                                                    <textarea id="deskripsi" name="deskripsi" cols="100" rows="4" value="{{$pengguna->deskripsi}}" >{{$pengguna->deskripsi}}</textarea>
                                               
                                            </div>

                                            <div class="form-group">
                                                <label class="col-lg-12 col-md-12 control-label" > Logo Komunitas</label>
                                                <div class="col-lg-12 col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-12 col-md-12">
                                                    <input type="text" onkeypress="return event.charCode >= 48 && event.charCode <=57" class="form-control" id="nohp" name="nohp"  value="{{$pengguna->nohp}}"  >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-12 col-md-12">
                                                    <input type="text" onkeypress="return event.charCode >= 48 && event.charCode <=57" class="form-control" id="nowa" name="nowa"  value="{{$pengguna->nowa}}"  >
                                                </div>
                                            </div>
