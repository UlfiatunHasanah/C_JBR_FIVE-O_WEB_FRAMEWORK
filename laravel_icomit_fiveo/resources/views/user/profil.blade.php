                               ...
                               <ul class="nav navbar-nav menu_nav ml-auto">
                                   ...
                                   <li class="nav-item submenu dropdown">
                                       <a href="#" class="nav-link active dropdown-toggle" data-toggle="dropdown"
                                           ...
                                           aria-expanded="false">{{ $pengguna->coname }}</a>
                   ...
                   <div class="row">
                       <div class="col-lg-12 col-md-12">
                           ...
                           <div class="form-group">
                               <form action="{{ url('editkom/' . $pengguna->id . '/update') }}" enctype="multipart/form-data"
                                   ...
                                   <div class="form-group">
                                       ...
                                       <div class="col-md-12">
                                           <textarea id="deskripsi" name="deskripsi" cols="100" rows="4"
                                               value="{{ $pengguna->deskripsi }}">{{ $pengguna->deskripsi }}</textarea>
