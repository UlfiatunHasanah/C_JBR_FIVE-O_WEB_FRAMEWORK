		...
		<section class="body">
			...
			<header class="header">
				<div class="logo-container">
					<a href="#" class="logo">
						<img src="{{url('assets/images/1.png')}}" height="40" alt="JSOFT Admin')}}" />
					</a>
					...
					<div id="userbox" class="userbox">
						<a href="#" data-toggle="dropdown">
							<figure class="profile-picture">
								<img src="{{url('assets/images/4.jpg')}}" alt="Joseph Doe" class="img-circle" data-lock-picture="{{url('assets/images/!logged-user.jpg')}}" />
							</figure>
