    ...
    <section class="chooseus spad set-bg  section_gap_top " >
                        <div class="container">
                            ...
                            <h2 >Informasi Komunitas</h2>
                                        ...
                                        <form  action="/daftar" enctype="multipart/form-data" class="form-horizontal form-bordered" method="POST">
                                                @csrf
                                            <div class="form-group">
                                                <label class="col-lg-12 col-md-12 control-label" > Nama Komunitas</label>
                                                <div class="col-lg-12 col-md-12">
                                                    <input type="text" readonly="readonly" class="form-control" id="coname" name="coname" value="{{$pengguna->coname}}" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-12 col-md-12">
                                                    <input type="text" readonly="readonly" class="form-control" id="nama" name="nama" value="{{$pengguna->nama}}" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-12 col-md-12">
                                                    <input type="text" readonly="readonly" class="form-control" id="nama" name="nama" value="{{$pengguna->prov}}" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-12 col-md-12">
                                                    <input type="text" readonly="readonly" class="form-control" id="nama" name="nama" value="{{$pengguna->kab}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-12 col-md-12">
                                                    <input type="text" readonly="readonly" class="form-control" id="email" name="email" value="{{$pengguna->email}}"  >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-12 col-md-12">
                                                    <input type="text" readonly="readonly" onkeypress="return event.charCode >= 48 && event.charCode <=57" class="form-control" id="nohp" name="nohp"  value="{{$pengguna->nohp}}"  >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-12 col-md-12">
                                                    <input type="text" readonly="readonly" onkeypress="return event.charCode >= 48 && event.charCode <=57" class="form-control" id="nowa" name="nowa"  value="{{$pengguna->nowa}}"  >
                                                </div>
                                            </div>
