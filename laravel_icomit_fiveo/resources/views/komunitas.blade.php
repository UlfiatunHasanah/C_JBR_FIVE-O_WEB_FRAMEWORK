               ...
               <div class="container">
                   <div class="row">
                       <div class="col-lg-12 course_details_left">
                           ...
                           <div class="col-lg-12">
                               <form enctype="multipart/form-data" class="row contact_form" action="{{ url('/kom') }}"
                                   method="GET">
                                   <div class="col-md-4">
                               ...
                               <ul class="course_list">
                                   @foreach ($pengguna as $pengguna)
                                       <li class="justify-content-between d-flex">
                                           <p>{{ $pengguna->coname }}</p>
                                           <a class="primary-btn text-uppercase" href="{{ url('detailpengguna/'. $pengguna->id . '/') }}"
                                               method="GET">View Details</a>
                                       </li>
                                   @endforeach
